 ...
 */
AEntity::AEntity(const AEntity& other) { *this = other; }
 ...
 */
const std::vector<sf::Texture>& AEntity::getTexture() const { return _textures; }

/**
 * @brief Gets the sprite of the entity.
 */
const sf::Sprite& AEntity::getSprite() const { return _sprite; }
