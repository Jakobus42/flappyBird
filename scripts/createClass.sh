...
test_template='#include "../../include/%SUB_FOLDER%/%CLASS_NAME%.hpp"
#include <gtest/gtest.h>

/**
 * @test functionNameTestName
 * @brief ...
 */
TEST(%NAMESPACE%Test%CLASS_NAME%, functionNameTestName) {
...
This script creates a C++ class with header, source, and test files in canonical form.

Arguments:
  subfolder   - The subdirectory under 'include', 'src', and 'tests' where the class files will be placed.
...
Each class will be generated with proper Doxygen documentation, and a Google Test boilerplate will be created.
